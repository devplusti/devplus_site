...
<body>
    ...
    <div id="outer-background-container" data-default-background-img="images/other_images/bg5.jpg" style="background-image: url(images/other_images/bg5.jpg);"></div>
    ...
    <div id="outer-container">
        ...
        <section id="left-sidebar">
            ...
            <div class="logo">
                <a href="#intro" class="link-scroll">
                    <img src="images/other_images/logo.png" alt="Devplus" /></a>
            </div>
            <!-- .logo -->
            ...
            <ul id="main-menu">
                <li id="menu-item-text" class="menu-item scroll"><a href="#text">Framework+</a></li>
                <li id="menu-item-carousel" class="menu-item scroll"><a href="#carousel">Sistemas Legados</a></li>
                <li id="menu-item-grid" class="menu-item scroll"><a href="#grid">Soluções</a></li>
                <li id="menu-item-featured" class="menu-item scroll"><a href="#featured">Portifólio</a></li>
                <li id="menu-item-contact" class="menu-item scroll"><a href="#contact">Contato</a></li>
            </ul>
            <!-- #main-menu -->
        ...
        <section id="main-content" class="clearfix">
            ...
            <article id="text" class="section-wrapper clearfix" data-custom-background-img="images/other_images/bg1.jpg">
                <div class="content-wrapper clearfix">
                    <div class="col-sm-10 col-md-9 pull-right">
                        ...
                        <p class="feature-paragraph">
                            <img data-img-src="images/other_images/transp-image5b.png" class="lazy pull-right" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#carousel">Suspendisse molestie lorem odio</a>, sit amet. Laoreet consequat. Duis dictum lorem metus, vitae dapibus.
                        </p>
            ...
            <article id="carousel" class="section-wrapper clearfix" data-custom-background-img="images/other_images/bg6.jpg">
                <div class="content-wrapper clearfix">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <div class="carousel-text-content">
                                    <img src="images/other_images/transp-image1.png" class="icon" alt="Lorem Ipsum">
                                    ...
                                    <div class="content-to-populate-in-modal" id="modal-content-2">
                                        <h1>Lorem Ipsum</h1>
                                        <p>
                                            <img data-img-src="images/other_images/transp-image1.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet.
                                        </p>
                            ...
                            <div class="item">
                                <div class="carousel-text-content">
                                    <img src="images/other_images/transp-image6.png" class="icon" alt="Lorem Ipsum">
                                    ...
                                    <div class="content-to-populate-in-modal" id="modal-content-3">
                                        ...
                                        <p>
                                            <img data-img-src="images/other_images/transp-image6.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet.
                                        </p>
                                        <p>Laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio, sit amet.</p>
                                        <p>Suspendisse molestie lorem odio, sit amet. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio test.</p>
                                    </div>
                            ...
                            <div class="item">
                                <div class="carousel-text-content">
                                    <img src="images/other_images/transp-image7.png" class="icon" alt="Lorem Ipsum">
                                    ...
                                    <div class="content-to-populate-in-modal" id="modal-content-4">
                                        ...
                                        <p>
                                            <img data-img-src="images/other_images/transp-image7.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet.
                                        </p>
                                        <p>Laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio, sit amet.</p>
                                        <p>Suspendisse molestie lorem odio, sit amet. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio test.</p>
                                    </div>
                            ...
                            <div class="item">
                                <div class="carousel-text-content">
                                    <img src="images/other_images/transp-image4.png" class="icon" alt="Lorem Ipsum">
                                    ...
                                    <div class="content-to-populate-in-modal" id="modal-content-5">
                                        ...
                                        <p>
                                            <img data-img-src="images/other_images/transp-image4.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet.
                                        </p>
                                        <p>Laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio, sit amet.</p>
                                        <p>Suspendisse molestie lorem odio, sit amet. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio test.</p>
                                    </div>
            ...
            <article id="grid" class="section-wrapper clearfix" data-custom-background-img="images/other_images/bg2.jpg">
                <div class="content-wrapper clearfix">
            ...
            <article id="featured" class="section-wrapper clearfix" data-custom-background-img="images/other_images/bg3.jpg">
                <div class="content-wrapper clearfix">
                        ...
                        <section class="feature-columns row clearfix">
                            ...
                            <article class="feature-col col-md-4">
                                <a href="" onclick="populate_and_open_modal(event, 'modal-content-6');" class="thumbnail linked">
                                    <div class="image-container">
                                        <img data-img-src="images/other_images/project-3.jpg" class="lazy item-thumbnail" alt="Lorem Ipsum">
                                    </div>
                                    <div class="caption">
                                ...
                                <div class="content-to-populate-in-modal" id="modal-content-6">
                                    <h1>Sed scelerisque</h1>
                                    <p>
                                        Nullam ac rhoncus. Aliquam adipiscing eros non elit imperdiet congue. Etiam at ligula sit amet arcu laoreet consequat.<br />
                                    </p>
                                    ...
                                    <div id="unique-id-for-image-slider" class="owl-carousel popup-image-gallery">
                                        ...
                                        <div>
                                            ...
                                            <img class="lazyOwl" data-src="images/other_images/bg1.jpg">
                                        </div>
                                        <!-- slide -->
                                        <div>
                                            <h6 class="caption">Caption for Image 2</h6>
                                            <img class="lazyOwl" data-src="images/other_images/bg2.jpg">
                                        </div>
                                        <!-- slide -->
                                        <div>
                                            <h6 class="caption">Caption for Image 3</h6>
                                            <img class="lazyOwl" data-src="images/other_images/bg3.jpg">
                                        </div>
                                    </div>
                                </div>
                                <!-- #modal-content-6 -->
                            ...
                            <article class="feature-col col-md-4">
                                <a href="" onclick="populate_and_open_modal(event, 'modal-content-7');" class="thumbnail linked">
                                    <div class="image-container">
                                        <img data-img-src="images/other_images/project-2.jpg" class="lazy item-thumbnail" alt="Lorem Ipsum">
                                    </div>
                                    <div class="caption">
                                        <h5>Text popup</h5>
                                ...
                                <div class="content-to-populate-in-modal" id="modal-content-7">
                                    <img data-img-src="images/other_images/top-image2.jpg" class="lazy full-width" alt="Lorem Ipsum">
                                    <h1>Sed scelerisque</h1>
                            ...
                            <article class="feature-col col-md-4">
                                <a href="" onclick="populate_and_open_modal(event, 'modal-content-8', '', 'full-size');" class="thumbnail linked">
                                    <div class="image-container">
                                        <img data-img-src="images/other_images/project-4.jpg" class="lazy item-thumbnail" alt="Lorem Ipsum">
                                    </div>
                                    <div class="caption">
                                ...
                                <div class="content-to-populate-in-modal" id="modal-content-8">
                                    ...
                                    <div id="unique-id-for-alt-image-slider" class="owl-carousel popup-alt-image-gallery">
                                        <div class="item">
                                            <a href="images/other_images/bg1.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-1.jpg"></a>
                                        </div>
                                        <div class="item">
                                            <a href="images/other_images/bg2.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-2.jpg"></a>
                                        </div>
                                        <div class="item">
                                            <a href="images/other_images/bg3.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-3.jpg"></a>
                                        </div>
                                        <div class="item">
                                            <a href="images/other_images/bg4.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-4.jpg"></a>
                                        </div>
                                        <div class="item">
                                            <a href="images/other_images/bg5.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-5.jpg"></a>
                                        </div>
                                        <div class="item">
                                            <a href="images/other_images/bg6.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-6.jpg"></a>
                                        </div>
                                        <div class="item">
                                            <a href="images/other_images/bg2.jpg" data-lightbox="popup-alt-gallery">
                                                <img class="lazyOwl" data-src="images/other_images/gallery-thumb-2.jpg"></a>
            ...
            <article id="contact" class="section-wrapper clearfix" data-custom-background-img="images/other_images/bg4.jpg">
                <div class="content-wrapper clearfix">
                    ...
                    <div class="contact-details col-sm-5 col-md-3">
                        <p itemscope itemtype="http://data-vocabulary.org/Organization">
                            <span style="font-family: Charcoal; font-style: normal; font-variant: normal; font-weight: 600; font-size: 18px;" itemprop="address" itemscope itemtype="http://data-vocabulary.org/Address">
                                <a href="https://www.google.com.br/maps/place/R.+Tocantins,+622+-+Vila+Almeida,+Indaiatuba+-+SP,+13330-670/@-23.0799977,-47.2211717,7z/data=!4m2!3m1!1s0x94c8b35da5926077:0x778722e88765c3b9">
                                    <span itemprop="street-address">Rua Tocantins, 622</span>
                                    <br />
                                    <span itemprop="locality">Indaiatuba</span>,
                            <span itemprop="region">SP</span>
                                </a>
                            </span>
                        </p>
                        <p>
                            <span itemprop="phone">Tel: 19 99252-0315</span>
                        </p>
                        <p>
                            <span style="font-family: Charcoal; font-style: normal; font-variant: normal; font-weight: 600; font-size: 24px;" itemprop="email"><a href="mailto:elton@devplus.com.br">contato@devplus.com.br</a> </span>
                        </p>
                    </div>
                    <!-- END: CONTACT DETAILS -->
                    ...
                    <div class="col-sm-7 col-md-9">
                        <form id="formContato" runat="server">

                            <!-- form left col -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input runat="server" id="name" type="text" class="text-field form-control validate-field required" data-validation-type="string" placeholder="Full Name" name="name" />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea placeholder="Message..." class="form-control validate-field required" name="message" rows="6">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-outline-inverse">Enviar</button>
                                </div>
        ...
        <section id="footer">
            ...
            <ul class="social-icons">
                <li><a href="https://www.facebook.com/devplusti" target="_blank" title="Facebook">
                    <img src="images/theme_images/social_icons/facebook.png" alt="Facebook"></a></li>
                <li><a href=" https://twitter.com/devplus_ti" target="_blank" title="Twitter">
                    <img src="images/theme_images/social_icons/twitter.png" alt="Twitter"></a></li>
                <li><a href="http://br.linkedin.com/pub/devplus-desenvolvimento" target="_blank" title="linkedin">
                    <img src="images/theme_images/social_icons/linkedin.png" alt="Google+"></a></li>
            </ul>

            <!-- copyright text -->
            <div class="footer-text-line">&copy; 2015 Devplus TI</div>
        </section>
        <!-- end: Footer -->
    ...
    $(document).ready(function(){
      jQuery("#outer-background-container").backstretch("images/other_images/bg5.jpg");
    });
    </script> 
    <![endif]-->
